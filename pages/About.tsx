...
export function About() {
      return (
        <section className="bg-background-gray h-[80vh] font-gothic w-full gap-14 flex flex-col items-center">
            ...
            <hr className="w-80 h-1 bg-aqua-green border-aqua-green" />
                ...
                <p className="text-2xl w-[45rem] self-center leading-10 z-10">
            ...
            <aside className="absolute right-0 z-0">
                <Image src={Circle} alt={"circle-light-blue"} />
            </aside>
            <aside className="absolute left-0 z-0">
