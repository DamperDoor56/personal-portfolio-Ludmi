...
export const Navbar = () => {
  ...
  return (
    <nav
      className="bg-dark-blue px-10 pb-5 pt-3
    flex justify-center"
    >
      ...
      dark:focus:ring-gray-600"
        ...
        <div
          className={classNames(
            "flex-row gap-10 font-gothic w-full md:block md:w-auto duration-300 md:opacity-100",
            openNav ? "opacity-100" : "opacity-0"
          )}
        >
          <ul
            className="child:cursor-pointer child:font-medium
